// Lazy-loaded email service to prevent build errors
// Resend client is created only when sending emails, not at module load
...
export async function sendOTPEmail(email: string, otp: string): Promise<boolean> {
  ...
  try {
    ...
    const fromEmail = process.env.RESEND_FROM_EMAIL || 'TheFinlog <noreply@thefinlog.com>'
