                  ...
                  <div className="flex justify-center gap-2 sm:gap-3">
                    {otp.map((digit, index) => (
                      <input
                        ...
                        className="w-10 h-12 sm:w-12 sm:h-14 text-center text-xl font-bold rounded-lg border-2 border-border bg-muted/50 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:bg-background transition-all outline-none"
                        disabled={isLoading}
                      />
                    ))}
                  </div>
